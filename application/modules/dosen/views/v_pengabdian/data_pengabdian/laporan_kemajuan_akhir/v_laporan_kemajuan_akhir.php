                ...
                <?php            
                   ...
                   <?php if(!isset($cek_upload)): ?>
                    <form method="POST" class="form" enctype="multipart/form-data"
                        action="<?= base_url('dosen/Pengabdian/upload_laporan_kemajuan_akhir') ?>" data-parsley-validate>
                        <div class="col-md-4">
            ...
            <div class="card">
                <div class="card-header">
                    <a class="btn btn-primary"
                        href="<?= base_url('dosen/tambah-laporan-kemajuan-akhir-pengabdian/').$pengabdian; ?>"><i
                    ...
                    <table class="table table-bordered" id="table1">
                        ...
                        <?php if($lp['status_lp_kemajuan_akhir'] == 'Belum Lengkap'){ ?>
                                    <a title="Hapus lp kemajuan"
                                        href="<?= base_url('dosen/Pengabdian/delete_lp_kemajuan_akhir/').$lp['id_luaran_hasil'] ?>"
                                        class="btn btn-danger btn-hapus" onclick="return confirm('Yakin ?')"><i
                                            class="fas fa-fw fa-trash"></i></a>
                    <?php } ?>
