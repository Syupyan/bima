<div class="content-wrapper container">
    ...
    <div class="page-heading">
        <h3><?= $title ?></h3>
        <a class="btn btn-danger" href="<?= base_url('reviewer/data-penelitian-laporan/').$penelitian; ?>"><i
                ...
                <div class="card-body">
                    <table class="table table-bordered" id="table1">
                        ...
                        foreach ($lp_kemajuan as $lp): ?>
                            ...
                            ?>
                                ...
                                <td><?= $lp['deskripsi'] ?></td>
                                <td>
                                    <?php if ($lp['status_lp_kemajuan']=='Sudah Sesuai'){
                    ...
                    ?>
                                    <div class="form-check form-switch fs-6">
                                        <input <?=  $status; ?> type="checkbox" value="<?= $lp['status_lp_kemajuan'] ?>"
...
<?php endforeach; ?>
    ...
    $(document).ready(function() {
        ...
        $(".btn-lp-kemajuan").click(function() {
            ...
            let status_lp_kemajuan = $(this).val()
            $.ajax({
                url: "<?= base_url('reviewer/Data_Reviewer/status_lp_kemajuan/') ?>",
                type: "GET",
                data: {
                    id_lp_kemajuan: id_lp_kemajuan,
                    status_lp_kemajuan: status_lp_kemajuan
                },
                success: function() {
                    document.location.href = "<?= base_url('reviewer/data-laporan-kemajuan-penelitian/').$penelitian ?>";
                },
                error: function() {
