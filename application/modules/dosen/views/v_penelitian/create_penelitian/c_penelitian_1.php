...
<div class="content-wrapper container">
    ...
    <div class="page-content">
        ...
        <!-- Basic Tables start -->
        <?php foreach($penelitianku1 as $penelitianku1){ ?>
        <?php if($penelitianku1['status_aktif'] == 'Disetujui'){ ?>
        <!-- Basic Tables start -->
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <a class="btn btn-danger" href="<?= base_url('dosen/penelitian'); ?>"><i
                            class="fas fa-fw fa-arrow-left"></i> Kembali</a>

                </div>
                <div class="card-body">
                    <form role="form" action="<?= base_url('dosen/Penelitian/add_penelitian_1') ?>" method="post"
                        ...
                        <fieldset>
                            ...
                            <input type="text" hidden name="nip_nik_ketua" value="<?= $user_login_data['nip_nik'] ?>"
                                placeholder="Judul Penelitian" class="f1-first-name form-control" id="f1-first-name">
                            <div class="form-group">
                                <label>Judul</label>
                                <input type="text" name="judul" placeholder="Judul Penelitian"
        ...
        <!-- /.content -->
        <?php }elseif(($penelitianku1['status_aktif'] == 'Draft')){ ?>
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <a class="btn btn-danger" href="<?= base_url('dosen/penelitian'); ?>"><i
                ...
                <div class="card-body">
                    <form role="form" action="<?= base_url('dosen/Penelitian/add_penelitian_1_1') ?>" method="post"
                        class="f1" data-parsley-validate>
                        <div class="f1-steps">
                            <div class="f1-progress">
                                <div class="f1-progress-line" data-now-value="12.5" data-number-of-steps="4"
                        ...
                        <fieldset>
                            <input hidden type="text" value="<?= $penelitianku1['id_penelitian'] ?>"
                                name="id_penelitian" placeholder="" class="f1-first-name form-control"
                                id="f1-first-name">
                            <input hidden type="text" value="<?= $penelitianku1['nip_nik_ketua'] ?>"
                                name="nik_nip_ketua" placeholder="" class="f1-first-name form-control"
                                id="f1-first-name">
                            <label for="">1.1 Identitas Usukan Penelitian </label>
                            <input type="text" hidden name="nip_nik_ketua" value="<?= $user_login_data['nip_nik'] ?>"
                                placeholder="Judul Penelitian" class="f1-first-name form-control" id="f1-first-name">
                            <div class="form-group">
                                <label>Judul</label>
                                <input type="text" name="judul" value="<?= $penelitianku1['judul'] ?>"
                            ...
                            <div class="form-group">
                                ...
                                <?php
// Ambil data tkt_awal dari tabel tbl_penelitian
$this->db->select('tkt_awal');
$this->db->from('tbl_penelitian');
$this->db->where('id_penelitian', $penelitianku1['id_penelitian']);
...
?>
                            ...
                            <div class="form-group">
                                ...
                                <?php
// Ambil data tkt_akhir dari tabel tbl_penelitian
...
$luaran_hasil = $this->db->select('*')
    ...
    ->where('penelitian_id', $penelitianku1['id_penelitian'])
    ->get()
    ->result_array();
...
?>
                            ...
                            <label for="">1.2 Pemilihan Program Penelitian </label>
                            <div class="form-group">
                                <label>Tema Penelitian</label>
                                <?php
// Ambil data tema_penelitian dari tabel tbl_penelitian
$this->db->select('tema_penelitian');
$this->db->from('tbl_penelitian');
$this->db->where('id_penelitian', $penelitianku1['id_penelitian']);
$query = $this->db->get();
$tema_penelitian_data = $query->row_array();

// Mendapatkan nilai tema_penelitian
$tema_penelitian_value = isset($tema_penelitian_data['tema_penelitian']) ? $tema_penelitian_data['tema_penelitian'] : '';

?>
                                <select name="tema_penelitian" class="form-select" id="">
                                    <?php foreach($tema_penelitian as $tp): ?>
                                    <option
                                        <?php echo ($tp['tema_penelitian'] == $tema_penelitian_value) ? 'selected' : ''; ?>>
                                        <?= $tp['tema_penelitian'] ?>
                                    </option>
                                    <?php endforeach; ?>
                                </select>
