    ...
    <div class="page-content">
        ...
        <!-- Main content -->
            ...
            <div class="card">
                ...
                <label for=""><Strong>Upload Laporan Kemajuan Akhir</Strong><small>(Pdf, Doc, Docx)</small></label><br><br>
                ...
                <?php            
                   ...
                   <?php if(!isset($cek_upload)): ?>
                    <form method="POST" class="form" enctype="multipart/form-data"
                        action="<?= base_url('dosen/Penelitian/upload_laporan_kemajuan_akhir') ?>" data-parsley-validate>
                        <div class="col-md-4">
                            <div class="input-group">
                                <input type="text" name="penelitian" value="<?= $penelitian ?>" hidden>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a title="Hapus lp upload"
                                        href="<?= base_url('dosen/Penelitian/delete_up_lp_kemajuan/').$lp['id_up_laporan'] ?>"
            ...
            <div class="card">
                <div class="card-header">
                    <a class="btn btn-primary"
                        href="<?= base_url('dosen/tambah-laporan-kemajuan-akhir-penelitian/').$penelitian; ?>"><i
                    ...
                    <table class="table table-bordered" id="table1">
                        ...
                        foreach ($lp_kemajuan as $lp): ?>
                            ...
                            ?>
                                ...
                                <td><?= $lp['deskripsi'] ?></td>
                                <td>
                        <?php if($lp['status_lp_kemajuan_akhir'] == 'Belum Lengkap'){ ?>
                                    <a title="Hapus lp kemajuan"
                                        href="<?= base_url('dosen/Penelitian/delete_lp_kemajuan_akhir/').$lp['id_luaran_hasil'] ?>"
                                        class="btn btn-danger btn-hapus" onclick="return confirm('Yakin ?')"><i
                                            class="fas fa-fw fa-trash"></i></a>
                                <?php } ?>
                                </td>
