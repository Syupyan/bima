                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php if ($pengabdian['status_pengabdian'] == 0): ?>
                                  ...
                                  <td>
                            <a target="_blank" title="detail pengabdian" href="<?= base_url('reviewer/detail-pengabdian-disahkan/').$pengabdian['id_pengabdian'] ?>"
                                    class="btn btn-info"><i class="fas fa-fw fa-info-circle"></i></a>
                                    <?php if($pengabdian['status_pengabdian'] == 4): ?>
                                        <a target="_blank" title="hasil pengabdian" href="<?= base_url('reviewer/hasil-pengabdian-disahkan/').$pengabdian['id_pengabdian'] ?>"
                                    class="btn btn-secondary"><i class="fas fa-fw fa-clipboard"></i></a>
                                    <a target="_blank" title="laporan pengabdian"
                                    href="<?= base_url('reviewer/data-pengabdian-laporan/').$pengabdian['id_pengabdian'] ?>"
                                    class="btn btn-success"><i class="fas fa-fw fa-book"></i></a>
                                    <a target="_blank" title="data evaluasi"
                                    href="<?= base_url('reviewer/data-evaluasi-pengabdian/').$pengabdian['id_pengabdian'] ?>"
