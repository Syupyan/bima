<?php            
                            $cek_user = $this->db->select('*')
													->from('tbl_penelitian')
													->where('id_penelitian', $idku['penelitian_id'])
...
<div class="content-wrapper container">
    ...
    <div class="page-heading">
        <h3><?= $title ?></h3>
        <a class="btn btn-danger" href="<?= base_url('dosen/logbook-penelitian/').$idku['penelitian_id']; ?>"><i
                ...
                <div class="row">
                    <div class="col-12 col-xl-4">
                        <div class="card">
                            ...
                            action="<?= base_url('dosen/Penelitian/add_foto_dokumen') ?>" enctype="multipart/form-data" data-parsley-validate>
                                    <table class='table table-bordered'>
                                    <input hidden type="text" name="id" value="<?= $penelitian; ?>">
                                ...
                                <form method="POST" class="form"
                                    action="<?= base_url('dosen/Penelitian/add_file_dokumen') ?>" enctype="multipart/form-data" data-parsley-validate>
                                    <table class='table table-bordered'>
                                        <input hidden type="text" name="id" value="<?= $penelitian; ?>">
                                ...
                                <form method="POST" class="form"
                                    action="<?= base_url('dosen/Penelitian/add_url_dokumen') ?>"
                        ...
                        <div class="card">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a title="Hapus Pengguna"
                                                    href="<?= base_url('dosen/Penelitian/delete_logbook_dok_foto/').$lf['id_dok'] ?>"
                            ...
                            class="fas fa-fw fa-download"></i> Download</a></td>
                                            <td><a title="Hapus dokumen"
                                                    href="<?= base_url('dosen/Penelitian/delete_logbook_dok_file/').$lf['id_dok'] ?>"
                                                    class="btn btn-danger btn-hapus"
                                                    onclick="return confirm('Yakin ?')"><i
                                                        class="fas fa-fw fa-trash"></i></a></td>
                                ...
                                <table class="table table-bordered" id="table3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a title="Hapus Dokumen"
                                                    href="<?= base_url('dosen/Penelitian/delete_logbook_dok_url/').$lf['id_dok'] ?>"
                                                    class="btn btn-danger btn-hapus"
                                                    onclick="return confirm('Yakin ?')"><i
                                                        class="fas fa-fw fa-trash"></i></a></td>
