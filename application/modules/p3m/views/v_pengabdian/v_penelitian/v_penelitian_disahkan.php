                ...
                <table class="table table-bordered" id="table1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <a title="detail penelitian" target="_blank" href="<?= base_url('p3m/detail-penelitian-disahkan/').$penelitian['id_penelitian'] ?>"
                                    class="btn btn-info"><i class="fas fa-fw fa-info-circle"></i></a>
                                    <a title="hasil penelitian" target="_blank" href="<?= base_url('p3m/hasil-penelitian-disahkan/').$penelitian['id_penelitian'] ?>"
