...
<div class="content-wrapper container">
    ...
    <h3><?= $title ?></h3>
    <a class="btn btn-danger" href="<?= base_url('admin/tabel-rekap-pengabdian/').$tahun['id_thn']; ?>"><i
                ...
                <table class="table table-bordered" id="table1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>            <a class="btn btn-primary" href="<?= base_url('admin/dokumen-logbook-pengabdian/').$logbook['id_logbook']; ?>"><i
