                ...
                <div class="row">
                    <div class="col-12 col-xl-4">
                        <div class="card">
                            ...
                            <form method="POST" class="form"
                                    action="<?= base_url('admin/Setting_Penelitian_Pengabdian/add_tema_penelitian') ?>" data-parsley-validate>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <a title="Hapus"
                                    href="<?= base_url('admin/Setting_Penelitian_Pengabdian/delete_tema_penelitian/').$tp['id_tema'] ?>"
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalScrollableTitle">Edit Tema Penelitian</h5>
            ...
            <div class="modal-body">
                <form method="POST" class="form" enctype="multipart/form-data"
                    action="<?= base_url('admin/Setting_Penelitian_Pengabdian/update_tema_penelitian') ?>" data-parsley-validate>
                    <div class="form-group">
                        <label>Tema Penelitian</label>
                        <input hidden type="text" name="id_tema" value="<?= $tp['id_tema'] ?>" class="form-control"></input>
                        <input type="text" name="tema_penelitian" value="<?= $tp['tema_penelitian'] ?>" class="form-control"></input>
                    </div>
                    <?= get_csrf() ?>
