...
<div class="content-wrapper container">
    ...
    <section class="section">
        <div class="card">
            ...
            <a class="btn btn-danger" href="<?= base_url('p3m/data-pengabdian-disahkan'); ?>"><i
                ...
                <table class="table table-bordered" id="table1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="<?= base_url('p3m/tabel-detail-pengabdian-disahkan/').$pengabdian['id_pengabdian'] ?>"
                                    class="btn btn-info"><i class="fas fa-fw fa-info-circle"></i></a>
                            <a href="<?= base_url('p3m/tabel-hasil-pengabdian-disahkan/').$pengabdian['id_pengabdian'] ?>"
