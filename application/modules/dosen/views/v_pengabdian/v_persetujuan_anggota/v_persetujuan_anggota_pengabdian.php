<?php 		$user			=  $this->db->select('*')
											...
											->get()->row_array(); ?>
<?php if($user['status_anggota'] == 'Menunggu'){ ?>
                    ...
                    <form role="form" class="f1" data-parsley-validate>
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" readonly value="<?= $pengabdianku['tema_pengabdian'] ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="position-relative">
                                    <a target="_blank" href="<?= base_url('user/User/download_file/pdf_proyek/').$pengabdianku['subtansi_usulan'] ?>"
                            ...
                            <div class="form-group">
                                <h10 style="color:red;">Dengan Data yang ada pada draft, apakah anda menyetujui agar
                                    data tersebut masuk dalam usulan ?</h10>
                            </div>
                            <?php 		$user			=  $this->db->select('*')
											->from('tbl_anggota')
											->join('tbl_pengguna', 'tbl_anggota.nip_nik_anggota = tbl_pengguna.nip_nik')
                            ...
                            <div class="f1-buttons">
                                <a href="<?= base_url('dosen/Pengabdian/persetujuan_pengabdian_anggota/').$user['id_anggota'] ?>"
                                    class="btn btn-primary btn-hapus">Setuju</a>
                                <a href="<?= base_url('dosen/Pengabdian/persetujuan_pengabdian_anggota_tolak/').$user['id_anggota'] ?>"
