    ...
    <div class="page-content">
        <section class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <a
                                                    href="<?= base_url('dosen/tabel-penelitian-anggota/') . $tahun_aktif['id_thn'] ?>">
                                                    <h6 class="text-muted font-semibold">Penelitian
            ...
            $tahun = $this->db->select('*')
                ...
                ->where('tbl_penelitian.tahun_id', $tahun_aktif['id_thn'])
            ...
            ?>
                                            ...
                                            <a href="<?= base_url('dosen/tabel-penelitian-anggota/') . $tahun_aktif['id_thn'] ?>"
