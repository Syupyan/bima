                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:128px;">
                                                            ...
                                                            <img height="auto" src="https://i.imgur.com/bcu1ANy.png" style="border:0;display:block;outline:none;text-decoration:none;width:100%;" width="128" />
                                    ...
                                    <tr>
                                        <td align="center" style="font-size:0px;padding:10px 25px;padding-bottom:40px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:18px;line-height:1;text-align:center;color:#555;">
                                                Akun atas nama <?= $nama ?>, Telah mengirimkan email Aktivasi.
                                            </div>
