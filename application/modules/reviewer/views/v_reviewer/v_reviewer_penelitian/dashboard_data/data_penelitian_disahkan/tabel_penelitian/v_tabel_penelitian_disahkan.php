...
<div class="content-wrapper container">
    ...
    <section class="section">
        <div class="card">
            ...
            <a class="btn btn-danger" href="<?= base_url('reviewer/data-penelitian-disahkan'); ?>"><i
                ...
                <table class="table table-bordered" id="table1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="<?= base_url('reviewer/tabel-detail-penelitian-disahkan/').$penelitian['id_penelitian'] ?>"
                                    class="btn btn-info"><i class="fas fa-fw fa-info-circle"></i></a>
                                    <?php if ($penelitian['status_penelitian'] != 5): ?>
                            <a href="<?= base_url('reviewer/tabel-hasil-penelitian-disahkan/').$penelitian['id_penelitian'] ?>"
