<div class="content-wrapper container">
    <div class="page-heading">
        <h3><?= $title ?></h3>
        <a class="btn btn-danger" href="<?= base_url('admin/data-setting-penelitian'); ?>"><i
            ...
            <div class="col-12 col-lg-15">
                    ...
                    <div class="col-12 col-xl-4">
                        <div class="card">
                            <div class="card-header">
                                <h4>Tambah Luaran Wajib Penelitian</h4>
                            </div>
                            <div class="card-body">
                                <form method="POST" class="form"
                                    action="<?= base_url('admin/Setting_Penelitian_Pengabdian/add_luaran_wajib_penelitian') ?>"
                                    data-parsley-validate>
                                    <table class='table table-bordered'>
                                        <tr>
                                            <td><label>Luaran Wajib Penelitian</label></td>
                                            <td>
                                ...
                                <table class="table table-bordered" id="table1">
                                    ...
                                    <tbody>
                                        ...
                                        data-bs-target="#exampleModalScrollable<?= $tp['id_luaran'] ?>"><i
                                            ...
                                            <a title="Hapus"
                                                    href="<?= base_url('admin/Setting_Penelitian_Pengabdian/delete_luaran_wajib_penelitian/').$tp['id_luaran'] ?>"
                ...
                <div class="row">
                    <div class="col-12 col-xl-4">
                        <div class="card">
                            <div class="card-header">
                                <h4>Tambah Luaran Tambahan Penelitian</h4>
                            </div>
                            <div class="card-body">
                                <form method="POST" class="form"
                                    action="<?= base_url('admin/Setting_Penelitian_Pengabdian/add_luaran_tambahan_penelitian') ?>"
                                    data-parsley-validate>
                                    <table class='table table-bordered'>
                                        <tr>
                                            <td><label>Luaran Tambahan Penelitian</label></td>
                                            <td>
                                                <div class="position-relative">
                    ...
                    <div class="col-12 col-xl-8">
                        <div class="card">
                            <div class="card-header">
                                <h4>Luaran Tambahan Penelitian</h4>
                            </div>
                            <div class="card-body">
                                <table class="table table-bordered" id="table2">
                                    ...
                                    <tbody>
                                        ...
                                        data-bs-target="#exampleModalScrollable1<?= $tp['id_luaran'] ?>"><i
                                            ...
                                            <a title="Hapus"
                                                    href="<?= base_url('admin/Setting_Penelitian_Pengabdian/delete_luaran_tambahan_penelitian/').$tp['id_luaran'] ?>"
                                                    class="btn btn-danger btn-hapus"
                                                    onclick="return confirm('Yakin ?')"><i
                                                        class="fas fa-fw fa-trash"></i></a>
                                                    </td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" class="form" enctype="multipart/form-data"
                    action="<?= base_url('admin/Setting_Penelitian_Pengabdian/update_luaran_wajib_penelitian') ?>" data-parsley-validate>
...
<div class="modal fade" id="exampleModalScrollable1<?= $tp['id_luaran'] ?>" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" class="form" enctype="multipart/form-data"
                    action="<?= base_url('admin/Setting_Penelitian_Pengabdian/update_luaran_tambahan_penelitian') ?>" data-parsley-validate>
                    <div class="form-group">
