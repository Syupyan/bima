                ...
                <?php            
                   ...
                   <?php if(!isset($cek_upload)): ?>
                    <form method="POST" class="form" enctype="multipart/form-data"
                        action="<?= base_url('dosen/Penelitian/upload_laporan_kemajuan') ?>" data-parsley-validate>
                        <div class="col-md-4">
    ...
    <div class="card">
        <div class="card-header">
            <a class="btn btn-primary"
                href="<?= base_url('dosen/tambah-laporan-kemajuan-penelitian/').$penelitian; ?>"><i
                    ...
                    <tr>
                        ...
                        <?php if($lp['status_lp_kemajuan'] == 'Belum Lengkap'){ ?>
                            <a title="Hapus lp kemajuan"
                                href="<?= base_url('dosen/Penelitian/delete_lp_kemajuan/').$lp['id_luaran_hasil'] ?>"
                                class="btn btn-danger btn-hapus" onclick="return confirm('Yakin ?')"><i
                                    class="fas fa-fw fa-trash"></i></a>
                    <?php } ?>
                        </td>
