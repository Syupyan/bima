                    ...
                    <form role="form" class="f1" data-parsley-validate>
                        ...
                        <fieldset>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if($user['status_anggota'] != "Disetujui"){ ?>
                                                <a title="Hapus Pengguna"
                                                    href="<?= base_url('dosen/Penelitian/delete_anggota_mhs/').$user['nim_anggota'] ?>"
                                                    class="btn btn-danger btn-hapus"
                                                    onclick="return confirm('Yakin ?')"><i
                                                        class="fas fa-fw fa-trash"></i></a>
                                                <?php } ?>
                            ...
                            <div class="f1-buttons">
                                ...
                                <?php if($penelitianku['status_penelitian'] == 1){ ?>
                                <?php }else{ ?>
                                <a title="Kirim Ke kepala p3m"
                                    href="<?= base_url('dosen/Penelitian/kirim_admin_p3m/').$penelitianku['id_penelitian'] ?>"
...
<div class="modal fade text-left" id="inlineForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33"
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('dosen/Penelitian/add_anggota_dosen_detail') ?>" method="post"
...
<div class="modal fade text-left" id="inlineForm1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33"
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('dosen/Penelitian/add_anggota_mhs_detail') ?>" method="post"
                data-parsley-validate>
                <div class="modal-body">
                    <label>Data: </label>
                    <div class="form-group">
