        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <a class="btn btn-danger" href="<?= base_url('reviewer/usulan-pengabdian'); ?>"><i
                ...
                <div class="card-body">
                    <form role="form" action="<?= base_url('reviewer/Data_Reviewer/add_nilai_reviewer_pengabdian') ?>"
                            ...
                            <div class="form-group">
                                <table class="table table-bordered" id="table3">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input readonly type="text" id="hasil_1" class="form-control"
                                                    name="nilai[]"></input></td>
                                        </tr>
                                        <tr>
                                            <th>2</th>
                                            ...
                                            <input hidden type="text" value="<?= $pengabdianku['id_pengabdian'] ?>"
                                                name="pengabdian_id[]" placeholder="Judul" class="form-control">
                                            <td><input readonly type="text" id="hasil_2" class="form-control"
                                                    name="nilai[]"></input></td>
                                        </tr>
                                        <tr>
                                            <th>3</th>
                                            <td>Metode Pengabdian
                                            ...
                                            <input hidden type="text" value="<?= $pengabdianku['id_pengabdian'] ?>"
                                                name="pengabdian_id[]" placeholder="Judul" class="form-control">
                                            <td><input readonly type="text" id="hasil_3" class="form-control"
                                                    name="nilai[]"></input></td>
                                        </tr>
                                        <tr>
                                            <th>4</th>
                                            ...
                                            <input hidden type="text" value="<?= $pengabdianku['id_pengabdian'] ?>"
                                                name="pengabdian_id[]" placeholder="Judul" class="form-control">
                                            <td><input readonly type="text" id="hasil_4" class="form-control"
                                                    name="nilai[]"></input></td>
                                        </tr>
                                        <tr>
                                            <th>5</th>
                                            <td>Peluang Luaran Pengabdian
                                            ...
                                            <input hidden type="text" value="<?= $pengabdianku['id_pengabdian'] ?>"
                                                name="pengabdian_id[]" placeholder="Judul" class="form-control">
                                            <td><input readonly type="text" id="hasil_5" class="form-control"
                                                    name="nilai[]"></input></td>
                                        </tr>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"
                                        name="komentar_pengabdian" data-parsley-required="true"></textarea>
                                </div>
                            </div>
