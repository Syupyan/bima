            ...
            <div class="card">
                <div class="card-header">
                    <a class="btn btn-danger"
                        href="<?= base_url('dosen/tambah-pengabdian/2/').$pengabdianku['id_pengabdian']; ?>"><i
                            class="fas fa-fw fa-arrow-left"></i> Kembali</a>

                </div>
                <div class="card-body">
                    <form role="form" action="<?= base_url('dosen/Pengabdian/add_pengabdian_3') ?>" method="post"
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input hidden type="text" value="<?= $pengabdianku['id_pengabdian'] ?>"
                                    ...
                                    id="f1-first-name"></input>

                                <?php if ($pengabdianku['subtansi_usulan'] != 'usulan') { ?>
                                <table class="table table-bordered">
                                    <tr>
                                        <td>File telah diunggah:</td>
                                        <td>
                                            <a target="_blank"
                                                href="<?= base_url('user/User/download_file/pdf_proyek/').$pengabdianku['subtansi_usulan'] ?>"
