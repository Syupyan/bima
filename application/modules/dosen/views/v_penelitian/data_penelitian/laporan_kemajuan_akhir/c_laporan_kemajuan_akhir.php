            ...
            <div class="card">
                <div class="card-header">
                    <a class="btn btn-danger"
                        href="<?= base_url('dosen/data-laporan-kemajuan-akhir-penelitian/').$penelitian; ?>"><i
                            class="fas fa-fw fa-arrow-left"></i> Kembali</a>
                </div>
                <div class="card-body">
                    <form method="POST" class="form" enctype="multipart/form-data"
                        action="<?= base_url('dosen/Penelitian/add_laporan_kemajuan_akhir') ?>" data-parsley-validate>
                        <div class="row">
                                        ...
                                        <div class="input-group">
                                         <?php
                                                $luaran_terpilih = $this->db->select('luaran_hasil_id')
                                                    ...
                                                    ->where('tbl_luaran_hasil.penelitian_id',$penelitian)
                                                    ->get()->result_array();
                                                $nilai = array();
