    ...
    <div class="page-content">
        <section class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <a
                                                    href="<?= base_url('dosen/tabel-pengabdian-anggota/') . $tahun_aktif['id_thn'] ?>">
                                                    <h6 class="text-muted font-semibold">Pengabdian
            ...
            $tahun = $this->db->select('*')
                ...
                ->where('tbl_pengabdian.tahun_id', $tahun_aktif['id_thn'])
                ->where('tbl_pengabdian.status_pengabdian !=', 0)
                ->get()->num_rows();
            ?>
                                                <h6 class="font-extrabold mb-0"><?= $tahun ?></h6>
                                            </div>
                                            <a href="<?= base_url('dosen/tabel-pengabdian-anggota/') . $tahun_aktif['id_thn'] ?>"
