        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <a class="btn btn-danger" href="<?= base_url('dosen/penelitian-aktif'); ?>"><i
                    ...
                    <form role="form" class="f1" data-parsley-validate>
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                <label>Komentar Reviewer</label><br>

                                <textarea readonly class="form-control" id="exampleFormControlTextarea1" rows="3"
                                    name="tugas_ketua"
                                    data-parsley-required="true"><?= $penelitianku['komentar_penelitian'] ?></textarea>
                            </div>
                            <div class="form-group">
                                <label>Judul</label>
