        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <a class="btn btn-danger" href="<?= base_url('p3m/dinilai-pengabdian'); ?>"><i
            ...
            ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input hidden type="text" value="<?= $pengabdian['id_pengabdian'] ?>"
                                        name="pengabdian_id_1" class="form-control">
                                    <input hidden  type="text" value="<?= $pengabdian['nip_nik_ketua'] ?>"
                                        name="nip_nik_ketua" class="form-control">
                                        <input hidden type="text" value="<?= $pengabdian['judul'] ?>"
                                        name="judul" class="form-control">
                                    <input hidden type="text" value="<?= $pengabdian['email'] ?>"
                            ...
                            <div class="row">
                                ...
                                <form role="form" action="<?= base_url('p3m/Pengabdian/pengabdian_ditolak/') ?>"
                        method="post" data-parsley-validate>
                        <input hidden type="text" value="<?= $pengabdian['id_pengabdian'] ?>"
                                        name="pengabdian_id_1" class="form-control">
                                    <input hidden  type="text" value="<?= $pengabdian['nip_nik_ketua'] ?>"
                                        name="nip_nik_ketua" class="form-control">
                                        <input hidden type="text" value="<?= $pengabdian['nip_nik'] ?>"
