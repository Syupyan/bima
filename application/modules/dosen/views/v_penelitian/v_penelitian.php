            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <?php }else{ ?>
                        <div class="col">
                            <a class="btn btn-primary" href="<?= base_url('dosen/tambah-penelitian/1'); ?>"><i
                                    class="fas fa-fw fa-plus"></i> Tambah Usulan Penelitian</a>
                        </div>
                        <?php } ?>
                        <?php } ?>
                        <?php } ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a target="_blank" title="Detail Penelitian"
                                        href="<?= base_url('dosen/detail-penelitian/').$penelitian['id_penelitian'] ?>"
