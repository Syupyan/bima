...
class Pengabdian extends CI_Controller {
	...
	{
		$data['title']					= 'Data Pengabdian Disahkan';
		$data['user_login_data'] 		= $this->user_login_data;
		$data['count_unread_pesan_pengabdian']		= $this->db->select('*')
										->from('tbl_pengabdian')
										->join('tbl_anggota', 'tbl_anggota.pengabdian_id = tbl_pengabdian.id_pengabdian')
	...
	{
		$data['title']				= 'Detail Data Pengabdian Disahkan';
		$data['user_login_data'] 	= $this->user_login_data;
		$data['count_unread_pesan_pengabdian']		= $this->db->select('*')
										->from('tbl_pengabdian')
										->join('tbl_anggota', 'tbl_anggota.pengabdian_id = tbl_pengabdian.id_pengabdian')
	...
	{
		$data['title']				= 'Hasil Data Pengabdian Disahkan';
		$data['user_login_data'] 	= $this->user_login_data;
		$data['count_unread_pesan_pengabdian']		= $this->db->select('*')
										->from('tbl_pengabdian')
										->join('tbl_anggota', 'tbl_anggota.pengabdian_id = tbl_pengabdian.id_pengabdian')
	...
	{
		$this->M_Pengabdian->update($id, ['status_pengabdian' => 2]);
		...
		if ($this->email->send()) {
			$this->session->set_flashdata('success', 'Pengabdian berhasil dikirim ke reviewer');
			redirect('p3m/usulan-pengabdian');
			die;
		} else {
