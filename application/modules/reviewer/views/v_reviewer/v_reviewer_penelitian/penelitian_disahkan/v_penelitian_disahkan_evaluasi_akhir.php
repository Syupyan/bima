        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <a class="btn btn-danger" href="<?= base_url('reviewer/data-evaluasi-penelitian/').$penelitian; ?>"><i
                ...
                <div class="card-body">
                    <form role="form" action="<?= base_url('reviewer/Penelitian/penelitian_disahkan/') ?>"
            ...
            ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" readonly
                                        ...
                                        data-parsley-required="true"><?= $penelitianku['komentar_evaluasi'] ?></textarea>
                                </div>
                            </div>
                            <br>
                            <?= get_csrf() ?>
...
<div class="content-wrapper container">
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <a class="btn btn-danger" href="<?= base_url('reviewer/data-evaluasi-penelitian/').$penelitian; ?>"><i class="fas fa-fw fa-arrow-left"></i> Kembali</a>
                <a target="_blank" href="<?= base_url('user/User/download_file/pdf_proyek/').$penelitianku['subtansi_usulan'] ?>" class="btn btn-info">Subtansi Usulan</a> 
            </div>
            <div class="card-body">
            <form role="form" action="<?= base_url('reviewer/Data_Reviewer/add_nilai_evaluasi_reviewer_penelitian_akhir') ?>"
                        method="post" data-parsley-validate>
                                <div class="row">
                                <div class="form-group">
                            <table class="table table-bordered" id="table3">
                                ...
                                <tbody>
                                    <tr>
                                        <th>1</th>
                                        <td>Persentase capaian pelaksanaan penelitian dari rencana yang ditetapkan.
                                        </td>
                                    ...
                                    <tr>
                                        <th>3</th>
                                        <td>Mutu dan potensi dampak hasil penelitian bidang keilmuan atau lingkupan/masyarakat.
                                        </td>
                                    ...
                                    <tr>
                                        <th>4</th>
                                        <td>Kelayakan ketercapaian target penelitian dan luaran pada periode yang tersisa.
                                        </td>
