...
<div class="content-wrapper container">
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                            <form method="POST" class="form" action="<?= base_url('admin/Master_Prodi/update_prodi') ?>" data-parsley-validate>
                                <div class="row">
                            <table class='table table-bordered'>
                            <input hidden name="id_prodi" type="text" class="form-control"
                                                        placeholder="Nama Lain Prodi" value="<?= $prodi['id_prodi'] ?>" id="nama" data-parsley-required="true">
                            <tr>
                                 <td ><label for="Nidn_Nidk">Nama Prodi</label></td>
                                 <td>
                                                <div class="position-relative">
                                                    <input name="nama_prodi" type="text" class="form-control"
                                                        placeholder="Nama Prodi" value="<?= $prodi['nama_prodi'] ?>" id="Nidn_Nidk" data-parsley-required="true">
                                 ...
                                 <td>
                                                <div class="position-relative">
                                                    <input name="nama_lain_prodi" type="text" class="form-control"
                                                        placeholder="Nama Lain Prodi" value="<?= $prodi['nama_lain_prodi'] ?>" id="nama" data-parsley-required="true">
