...
<div class="content-wrapper container">
    ...
    <section class="section">
        <div class="card">
            ...
            <a class="btn btn-primary" href="<?= base_url('dosen/tambah-logbook-pengabdian/').$pengabdian; ?>"><i
                ...
                <table class="table table-bordered" id="table1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>            <a title="Dokumen logbook" class="btn btn-primary" href="<?= base_url('dosen/dokumen-logbook-pengabdian/').$logbook['id_logbook']; ?>"><i
                            ...
                            <a title="Hapus logbook"
                                                    href="<?= base_url('dosen/Pengabdian/delete_logbook_1/').$logbook['id_logbook'] ?>"
