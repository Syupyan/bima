        ...
        <section class="section">
            ...
            <div class="card-header">
                                <div class="row align-items-center">
                                    <div class="col">
                                    <a class="btn btn-danger" href="<?= base_url('dosen/tambah-pengabdian/1'); ?>"><i
                ...
                <div class="card-body">
                    <form role="form" action="<?= base_url('dosen/Pengabdian/add_pengabdian_2') ?>" method="post"
                        ...
                        <label for="">1.3 Identitas ketua dan Anggota </label>
                            ...
                            <div class="form-group">
                                ...
                                <?php if(empty($pengabdianku['tugas_ketua'])){ ?>
...
<div class="modal fade text-left" id="inlineForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33"
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('dosen/Pengabdian/add_anggota_dosen') ?>" method="post" data-parsley-validate>
...
<div class="modal fade text-left" id="inlineForm1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33"
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('dosen/Pengabdian/add_anggota_mhs') ?>" method="post" data-parsley-validate>
                <div class="modal-body">
                    <label>Data: </label>
                    <div class="form-group">
